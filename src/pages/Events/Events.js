...
//   const eventsCacheKey = showUpcoming ? "upcomingEvents" : "pastEvents";
//   const cachedEvents = JSON.parse(localStorage.getItem(eventsCacheKey));
...
//         localStorage.setItem(eventsCacheKey, JSON.stringify(data.results));
//       })
//       .catch((error) => console.error("Error:", error));
//   };
