...
//                 )}
//                 {event.url && (
//                   <a href={event.news_url || event.video_url} className="events__event-link">
//                     Event Details
//                   </a>
//                 )}
//               </div>
...
//             <div
//               key={event.id}
//               className={`events__card ${expandedEventId === event.id ? "expanded" : ""}`}
...
//                   </p>
//                   <p className="events__location">{event.location}</p>
//                   <p className="events__status">Status: {event.status.name}</p>
...
//               <p className="events__description">{event.description}</p>
//               <p className="events__location">{event.location}</p>
//               {event.mission && ( // Check if mission exists before accessing its properties
//                 <>
//                   <p className="events__mission-type">Mission Type: {event.mission.type}</p>
//                   <p className="events__orbit">Orbit: {event.mission.orbit.name}</p>
//                 </>
...
//                       </>
//                     )}
//                     {event.rocket && event.rocket.configuration && ( // Check if rocket and configuration exist before accessing them
//                       <p className="events__rocket-family">Rocket Family: {event.rocket.configuration.family}</p>
//                     )}
//                     <p className="events__launch-provider">Launch Provider: {event.launch_service_provider.name}</p>
//                     {event.vid_urls.length > 0 && (
...
//                       <p className="events__rocket-family">Rocket Family: {event.rocket.configuration.family}</p>
//                     )}
//                     {event.launch_service_provider && ( // Check if launch_service_provider exists before accessing its name property
//                       <p className="events__launch-provider">Launch Provider: {event.launch_service_provider.name}</p>
//                     )}
//                     {event.vid_urls && event.vid_urls.length > 0 && ( // Check if vid_urls exists and has length before accessing its properties
//                       <a
//                         href={event.vid_urls[0].url}
//                         className="events__video-link"
//                       >
              ...
              <div className="events__details">
                ...
                {expandedEventId === event.id && (
                  <div className="events__expanded-details">
                    <p className="events__description">{event.description}</p>
                    <p className="events__location">{event.location}</p>
                    {event.mission && event.mission.type && ( // Check if mission and type exist before accessing them
                      <p className="events__mission-type">Mission Type: {event.mission.type}</p>
                    )}
